 ...
 * This trait provides methods to interact with the GatewayPay CopyAndPay Checkout API.
 */
trait CopyAndPayCheckout
{
    ...
    public function payCard($data = [])
    {
        ...
        $url = $this->baseUrl . '/v1' . GatewayPaySDK::URI_PAYMENTS;
    ...
    {
        $url = $this->baseUrl . GatewayPaySDK::URI_CHECKOUTS . '/' . $checkoutId . GatewayPaySDK::URI_PAYMENT . '?entityId=' . $this->entityId;
